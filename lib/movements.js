...
class Movements {
  ...
  getMoveJumpUp (node, dir, neighbors, currentXDirection) {
  ...
  getMoveForward (node, dir, neighbors, currentXDirection) {
    const blockB = this.getBlock(node, dir.x, 1, dir.z)
    const blockC = this.getBlock(node, dir.x, 0, dir.z)
    const blockD = this.getBlock(node, dir.x, -1, dir.z)
  ...
  getMoveDiagonal (node, dir, neighbors, currentXDirection) {
  ...
  getMoveDropDown (node, dir, neighbors, currentXDirection) {
    const blockB = this.getBlock(node, dir.x, 1, dir.z)
    const blockC = this.getBlock(node, dir.x, 0, dir.z)
    const blockD = this.getBlock(node, dir.x, -1, dir.z)
  ...
  getMoveParkourForward (node, dir, neighbors, currentXDirection) {
    const block0 = this.getBlock(node, 0, -1, 0)
  ...
  getNeighbors (node, currentXDirection) {
    ...
    for (const i in cardinalDirections) {
      ...
      this.getMoveForward(node, dir, neighbors, currentXDirection)
      this.getMoveJumpUp(node, dir, neighbors, currentXDirection)
      this.getMoveDropDown(node, dir, neighbors, currentXDirection)
      if (this.allowParkour) {
        this.getMoveParkourForward(node, dir, neighbors, currentXDirection)
      }
    }
    ...
    for (const i in diagonalDirections) {
      ...
      this.getMoveDiagonal(node, dir, neighbors, currentXDirection)
    }
